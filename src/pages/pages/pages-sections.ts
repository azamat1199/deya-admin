// Add a row here (plus a route in App.tsx) to register a new Pages section.
export const PAGES_SECTIONS = [
  ...
  { labelKey: "pages.tabs.banners", path: "banners" },
  { labelKey: "pages.tabs.mainText", path: "main-text" },
];
